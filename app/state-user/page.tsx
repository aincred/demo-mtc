...
export default function StateUserLogin() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    alert(`Welcome, ${username || "State User"}!`);
  };

  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-r from-green-700 to-green-500">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-auto p-8 space-y-6 relative">
        ...
        <h2 className="text-2xl font-semibold text-center text-green-700 mt-2">
          State User
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            className="w-full border rounded-lg p-2.5 focus:ring-2 focus:ring-green-400"
            required
          />
          <input
            type="password"
          ...
          <div>
            ...
            <div className="flex items-center mt-2 space-x-2">
              <input
                ...
                className="flex-1 border rounded-lg p-2.5 focus:ring-2 focus:ring-green-400"
                required
              />
              <button
                type="button"
